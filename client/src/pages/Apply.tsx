        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3" style={{ gap: "1px", backgroundColor: "oklch(0.88 0.005 80)" }}>
            {[
              ...
              { quote: "The interactive experience is awesome, always getting checked on and making sure you're doing all right and understanding everything. Jantzen is a great coach and communicator.", name: "Asher Little", tag: "Player" },
              { quote: "Just started working with Jantz but he's been great. Would definitely recommend.", name: "Toby Kessler", tag: "Player" },
