        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3" style={{ gap: "1px", backgroundColor: "oklch(0.95 0.003 80)" }}>
            {[
              ...
              { quote: "My experience has been great — there are over 50 guys in here and somehow it still feels like I'm the only one getting trained. This is ran really well and I'm getting better every day.", name: "Tony Woodie", tag: "Player · P.O. → Single Season HR & RBI Record Holder · 3 HR → 10 HR" },
