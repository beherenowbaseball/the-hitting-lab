...
export const drills: Drill[] = [
  ...
  },
  {
    ...
    category: "standard",
    villain: "Passive, coach-dependent practice habits",
    tagline: "Builds self-sufficient, high-rep skill development",
    whatItIs: "The hitter tosses the ball to themselves and hits it, developing timing, hand-eye coordination, and self-directed practice habits.",
    whyWeDoit: "Hitters who can only practice with a coach never develop true independence. Self-toss builds the ability to train anywhere, anytime, with full focus.",
